namespace BHD_Demo.Effects.Store;
...
public static class ThemeEffects
{
    ...
    public static void SetCircle(BindableObject view, bool value)
    {
        view.SetValue(CircleProperty, value);
    }
    ...
    {
        public CircleEffect() : base($"BHD_Demo.{nameof(CircleEffect)}")
        {
        }
    }
}